...
//             self.request.get(PushBullet.UPLOAD_END_POINT, authOptions).then(function(response) {
...
//                     self.handleError(response, callback);
//                 }
//             });
...
PushBullet.prototype.push = function push(deviceParams, bullet, callback) {
    ...
    self.request.post(PushBullet.PUSH_END_POINT, bullet).then(function(response) {
...
PushBullet.prototype.updatePush = function updatePush(pushIden, updates, callback) {
    ...
    self.request.post(PushBullet.PUSH_END_POINT + '/' + pushIden, updates).then(function(response) {
        self.handleResponse(response, callback);
    }, function(response) {
        self.handleError(response);
    });
...
PushBullet.prototype.deletePush = function deletePush(pushIden, callback) {
    var self = this;
    self.request.delete(PushBullet.PUSH_END_POINT + '/' + pushIden).then(function(response) {
        self.handleResponse(response, callback);
    }, function(response) {
        self.handleError(response);
    });
...
PushBullet.prototype.deleteAllPushes = function deleteAllPushes(callback) {
    ...
    self.request.delete(PushBullet.PUSH_END_POINT).then(function(response) {
        self.handleResponse(response, callback);
    }, function(response) {
        self.handleError(response);
    });
